...
import {monthlykpistatusComponentService} from './monthlykpistatus.service';
import {KPIPendingForApprovals, userDetails} from './monthlykpistatus.model';
...
@Component({
  selector: 'app-monthlykpistatus',
  templateUrl: './monthlykpistatus.component.html',
  styleUrls: ['./monthlykpistatus.component.scss']
})
export class MonthlykpistatusComponent implements OnInit {
  ...
  isApproved:boolean=true;
    constructor(private router: Router,private service:monthlykpistatusComponentService,
    ...
    getPendingApprovals()
    {
      this.service.getmonthlyKPIstatus(this.employee).subscribe(x => {
       this.dataList=x;
