...
import {updatedQIstatusComponentService} from './updated-qistatus.service';
import {KPIPendingForApprovals, userDetails} from './updated-qistatus.model';
...
@Component({
  selector: 'app-updated-qistatus',
  templateUrl: './updated-qistatus.component.html',
  styleUrls: ['./updated-qistatus.component.scss']
})
export class UpdatedQIStatusComponent implements OnInit {
  ...
  constructor(private router: Router,private service:updatedQIstatusComponentService,
